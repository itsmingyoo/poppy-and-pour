...
await prisma.product.createMany({
  data: [
    ...
    {
      category: "Plates",
      productName: "SilverShinePlate",
      price: 75,
      color: "silver",
      description: "Elegant silver plate",
    },
    {
      category: "Mugs",
      productName: "MugMaster",
      price: 15,
      color: "blue",
    ...
    {
      category: "Bowls",
      productName: "SuperBowl",
      price: 50,
      color: "white",
      description: "Versatile serving bowl",
    },
  ],
  skipDuplicates: true,
});
...
await prisma.review.createMany({
  data: [
    {
      review: "yeah great product yeah uhhuh",
      rating: 4,
      userId: 1,
      productId: 1,
    },
    {
      review: "Awesome product, highly recommended!",
      rating: 5,
      userId: 2,
      productId: 2,
    },
    ...
    {
      review: "Could be better, not very satisfied",
      rating: 2,
      userId: 4,
      productId: 4,
    },
