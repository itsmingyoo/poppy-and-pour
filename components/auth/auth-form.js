...
function AuthForm() {
    ...
    async function submitHandler(e) {
        ...
        if(isLogin) {
            ...
            if(password.trim().length > 30 ) errorObj.password = "Password Must not exceed 30 characters in length"
            ...
            const errorsObj = {}
            if(!firstName) errorsObj.firstName = "WHATS YOUR FIRST NAME DIPSHIT"
            if(!password) errorsObj.password = "Please provide a password"
            if(password.trim().length > 30 ) errorsObj.password = "Password Must not exceed 30 characters in length"
